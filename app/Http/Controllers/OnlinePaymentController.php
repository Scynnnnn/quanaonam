...
{
    public $vnp_TmnCode = "VZ827WES"; //Mã website tại VNPAY
    public $vnp_HashSecret = "VWPXBGWCNOACACTMORBGGNCDDAETUXXQ"; //Chuỗi bí mật
...
//                    $vnp_Url .= 'name=' .'truong quang viet';
